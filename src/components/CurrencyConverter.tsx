...
export default function CurrencyConverter() {
    ...
    async function handleSubmit() {
        if (to && from && amount) {
            ...
            const currentRate: IRate = { baseCurrency, targetCurrency, exchangeRate: 0, baseRate: resultBaseRate, targetRate: resultTargetRate, amount: parseInt(amount) };
            currentRate.exchangeRate = resultBaseRate * parseInt(amount);
            setRate(currentRate);
